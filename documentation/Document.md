...
- Отображается список постояльцев сортированных по "Arrival time", у которых "Arrival time" больше или равно введеному "
  Arrival time" и "Departure time" меньше или равно введеному "Departure time";
- Если удовлетворяющих требованиям поиска постояльцев нет, то отображается страница без

![Рис. 3.5 Просмотр списка постояльцев](doc_photos/Cut_resident_with_search_and_date.jpg)

Рис. 3.5 Поиск постояльца по дате